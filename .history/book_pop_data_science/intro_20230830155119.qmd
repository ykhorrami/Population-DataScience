...
We refer the reader to the following [website](https://www.makeuseof.com/how-to-install-python-on-mac/) <https://www.makeuseof.com/how-to-install-python-on-mac/> for instructions on installing Python on Mac OS.
